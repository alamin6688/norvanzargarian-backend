...
// Protected routes
router.post("/logout", auth("DRIVER", "COMPANY", "ADMIN"), AuthController.logout);

router.get("/me", auth("DRIVER", "COMPANY", "ADMIN"), AuthController.getMe);

router.post(
  "/change-password",
  auth("DRIVER", "COMPANY", "ADMIN"),
